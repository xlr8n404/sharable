      ...
      <div className="px-4 pt-4 pb-4">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            {/* Full name: 16px height, 80px width (Username removed) */}
            <Skeleton className="h-[16px] w-[80px] bg-zinc-200 dark:bg-zinc-800" />
          </div>
        ...
        <div className="flex items-center justify-between mt-6">
          {/* Left side: 120px width, 24px height */}
          <Skeleton className="h-[24px] w-[120px] bg-zinc-100 dark:bg-zinc-900" />
